...
(function() {
  ...
  module.exports = Skinnyjs = (function() {
    ...
    Skinnyjs.prototype.init = function(cb) {
      ...
      compilerPath = this.cfg.layout.configs + this.path.sep + 'compiler.js';
      if (this.fs.existsSync(compilerPath)) {
        this.initModule('configs', {
          path: compilerPath
        });
      }
      return this.precompile((function(_this) {
        return function() {
