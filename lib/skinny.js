...
(function() {
  ...
  module.exports = Skinnyjs = (function() {
    ...
    Skinnyjs.prototype.error = function(error) {
      ...
      return console.log(this.colors.red + 'initModule failure' + this.colors.reset, 'on:', type, opts, 'error:', error.message, error.toString());
    };
