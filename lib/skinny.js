...
(function() {
  ...
  module.exports = Skinnyjs = (function() {
    ...
    Skinnyjs.prototype.initModule = function(type, opts) {
      ...
      if (!opts.path.match(/\.js$/ || opts.path.indexOf(this.path.sep + 'assets' + this.path.sep !== "-1" || opts.path.indexOf(this.path.sep + 'client' + this.path.sep !== "-1")))) {
        return true;
      }
      if (!opts.path.match(/\.js$/)) {
        return true;
      }
      if (parseInt(opts.path.indexOf(this.path.sep + 'client' + this.path.sep), 10) > -1) {
        return true;
      }
