    ...
    Skinnyjs.prototype.init = function() {
      ...
      if (this.cfg.reload) {
        ...
        watchAction = function(file) {
          ...
          if (file.match(_this.path.set + '.git' || file.match(_this.path.set + 'assets' || file.match(_this.path.set + 'vendor' || file.substr(-4) === '.tmp' || file.substr(-4) === '.swp')))) {
            skip = true;
          }
          ...
          if ((_this.compiler != null) && _this.compiler[_this.path.extname(file)]) {
      ...
      return app._.each(app.routes, function(obj, route) {
        return app.server[obj.method || 'get'](route, function(req, res) {
          ...
          if (controllerOutput != null) {
            ...
            if (this.fs.existsSync(res.view)) {
