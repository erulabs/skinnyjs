...
(function() {
  ...
  module.exports = Skinnyjs = (function() {
    ...
    Skinnyjs.prototype.error = function(error, opts) {
      ...
      return console.log(this.clr.red + 'Exception: ' + opts.error + this.clr.reset, 'in', (opts.details.name != null ? '"' + opts.details.name + '"' : opts), opts.type.substr(0, opts.type.length - 1), "\n" + this.clr.cyan + "stack:" + this.clr.reset, error.stack);
    };
