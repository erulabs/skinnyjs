...
(function() {
  ...
  module.exports = Skinnyjs = (function() {
    ...
    Skinnyjs.prototype.initModel = function(model, name) {
      ...
      if (model.find == null) {
        model.find = function(query, cb) {
          ...
          return skinny.db.collection(name).find(query).toArray(function(err, results) {
    ...
    Skinnyjs.prototype.parseRoutes = function() {
      var _this = this;
      return this._.each(this.routes, function(obj, route) {
        return _this.server[obj.method || 'get'](route, function(req, res) {
          var controllerOutput, error;
          if (_this.controllers[obj.controller] != null ? _this.controllers[obj.controller]['*'] != null : void 0) {
          ...
          try {
            if (_this.controllers[obj.controller] != null ? _this.controllers[obj.controller][obj.action] != null : void 0) {
